...
class SurfaceData(MappedType):
    ...
    vertices = arrays.PositionArray(
        ...
        order=-1,
        console_default=default.read_data(file_name="vertices.txt", field="vertices"),
    ...
    triangles = arrays.IndexArray(
        ...
        order=-1,
        target=vertices,
        console_default=default.read_data(file_name="triangles.txt", dtype=numpy.int32, field="triangles"),
